...
func main() {
	...
	publicAPI := router.Group("/api")
	{
		...
		protected.Use(utils.JWTMiddleware())
		{
			...
			protected.POST("/rooms/:id/stage-notes", handlers.CreateRoomStageNote)
			protected.PUT("/rooms/:id/stage-notes/:noteId", handlers.UpdateRoomStageNote)
			protected.DELETE("/rooms/:id/stage-notes/:noteId", handlers.DeleteRoomStageNote)
			protected.POST("/rooms/:id/stage-images", handlers.CreateRoomStageImage)
			protected.PUT("/rooms/:id/stage-images/:imageId", handlers.UpdateRoomStageImage)
			protected.DELETE("/rooms/:id/stage-images/:imageId", handlers.DeleteRoomStageImage)
